...
# 3. 유저를 팔로우하는 사람 수를 알려주는 num_followers 메소드도 추가해봅시다.
...
class User:
    ...
    def follow(self, another_user):
        ...
        #self.following_list.append(another_user.email)
        #self.following_list.append(another_user.password)

        # 다른 사람의 팔로워 리스트
        #self.followers_list.append(another_user)
        another_user.followers_list.append(self.name)
        #another_user.followers_list.append(self.email)
        #another_user.followers_list.append(self.password)
